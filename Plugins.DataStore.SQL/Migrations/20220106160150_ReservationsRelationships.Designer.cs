...
namespace Plugins.DataStore.SQL.Migrations
{
    ...
    [Migration("20220106160150_ReservationsRelationships")]
    partial class ReservationsRelationships
    {
            ...
            modelBuilder.Entity("CoreBusiness.FleetVehicle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CurrentBranchId = 1,
                            DateAdded = new DateTime(2022, 1, 6, 0, 0, 0, 0, DateTimeKind.Local),
                            MaintenanceDate = new DateTime(2023, 1, 6, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            CurrentBranchId = 1,
                            DateAdded = new DateTime(2021, 1, 6, 0, 0, 0, 0, DateTimeKind.Local),
                            MaintenanceDate = new DateTime(2022, 2, 6, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            CurrentBranchId = 1,
                            DateAdded = new DateTime(2021, 10, 6, 0, 0, 0, 0, DateTimeKind.Local),
                            MaintenanceDate = new DateTime(2022, 1, 20, 0, 0, 0, 0, DateTimeKind.Local),
                            MaintenanceOdometer = 15000,
                            ModelVehicleId = 3,
                            Odometer = 5000,
                        ...
                        new
                        {
                            ...
                            CurrentBranchId = 4,
                            DateAdded = new DateTime(2021, 10, 6, 0, 0, 0, 0, DateTimeKind.Local),
                            MaintenanceDate = new DateTime(2022, 1, 27, 0, 0, 0, 0, DateTimeKind.Local),
                            MaintenanceOdometer = 15000,
                            ModelVehicleId = 3,
                            Odometer = 5000,
            ...
            modelBuilder.Entity("CoreBusiness.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReservationGuid = new Guid("f8537232-49be-4ea3-89b9-893971d2603a"),
                            EndBranchId = 1,
                            EndDateTime = new DateTime(2022, 1, 8, 17, 1, 50, 495, DateTimeKind.Local).AddTicks(7592),
                            FleetVehicleLicensePlate = "GD19791",
                            Price = 69,
                            StartBranchId = 2,
                            StartDateTime = new DateTime(2022, 1, 6, 17, 1, 50, 495, DateTimeKind.Local).AddTicks(7302)
                        });
                });
